	...
	<div class="header">
		<div class="header-auto">
			...
			<div class="header-search">
				<input type="text" :placeholder="lange.search_policy_system | strSplit" v-model="search" />
				<div class="button-submit"><a :href="'/vip_search.html#/home?type='+search" style="display:block">按钮</a></div>
			</div>
...
<script>
	import lange from './header-CN.json'
